...
file_path = "nylon_24_simple_2.xlsx"
...
def sin_function(t, A, omega, c, d):   
    return A*np.sin(omega*t+c)+d

params, covariance = curve_fit(
    sin_function, 
    data['t'][second_to_index(50):second_to_index(100)], 
    data['x'][second_to_index(50):second_to_index(100)], 
    p0=[x_amp, 0.2*np.pi, 0, 0],
)
print(x_amp)
print(params)
