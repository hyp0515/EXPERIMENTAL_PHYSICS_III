...
def extract_data_from_path(path):
    ...
    return data
data_L = extract_data_from_path("./tracker_file/coupled_pendulum/move_2_55cm/move_2_55cm_1_L.xlsx")
data_R = extract_data_from_path("./tracker_file/coupled_pendulum/move_2_55cm/move_2_55cm_1_R.xlsx")
# sync time
data_L['t'] = np.linspace(0, 140, len(data_L['t']))  
data_R['t'] = np.linspace(0, 142, len(data_R['t']))
...
# plt.savefig('./Figures/fft_move_2_55cm')
# plt.tight_layout()
# plt.show()
