...
def extract_data_from_path(path):
    ...
    return data
data_L = extract_data_from_path("./tracker_file/coupled_pendulum/move_1_40cm/couple_2_L.xlsx")
data_R = extract_data_from_path("./tracker_file/coupled_pendulum/move_1_40cm/couple_2_R.xlsx")
# sync time
new_t_L = np.linspace(0, 71, len(data_L['t']))  
new_t_R = np.linspace(0, 71, len(data_R['t']))
