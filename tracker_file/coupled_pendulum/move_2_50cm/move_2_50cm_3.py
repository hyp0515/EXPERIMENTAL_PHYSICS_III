...
def extract_data_from_path(path):
    ...
    return data
data_L = extract_data_from_path("./tracker_file/coupled_pendulum/move_2_50cm/move_2_50cm_3_L.xlsx")
data_R = extract_data_from_path("./tracker_file/coupled_pendulum/move_2_50cm/move_2_50cm_3_R.xlsx")
# sync time
data_L['t'] = np.linspace(0, 90, len(data_L['t']))  
data_R['t'] = np.linspace(0, 90, len(data_R['t']))
...
# plt.show()
###############################################################################
T = 90  # Total duration in seconds
