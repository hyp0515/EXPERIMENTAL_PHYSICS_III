...
def extract_data_from_path(path):
    ...
    return data
data_L = extract_data_from_path("./tracker_file/coupled_pendulum/move_2_50cm/move_2_50cm_1_L.xlsx")
data_R = extract_data_from_path("./tracker_file/coupled_pendulum/move_2_50cm/move_2_50cm_1_R.xlsx")
# sync time
data_L['t'] = np.linspace(0, 94, len(data_L['t']))  
data_R['t'] = np.linspace(0, 94, len(data_R['t']))
...
plt.xlabel(r"t[s]")
plt.ylabel(r"x[m]")
plt.savefig('./Figures/move_2_50cm')
plt.show()
###############################################################################
T = 94  # Total duration in seconds
